...
class RestaurantOrderManagement:
    def __init__(self,root):
        ...
        ttk.Label(frame, text="Restsurant Order Management", font=("Arial", 20, "bold")).grid(row=0, columnspan=3, padx=10, pady=10)
        self.menu_labels={}
        ...
        for i, (item, price) in enumerate(self.menu_items.items(),start=1):
            ...
            ttk.Label(frame, text="Currency:", font=("Arial",12)).grid(row=len(self.menu_items+1, column=0, padx=10, pady=5) currency_dropdown=ttk.Combobox(frame, textvariable=self.currency_var, state="readonly", width=18, values=("USD", "INR")) currency_dropdown.grid(row=len(self.menu_items)+1, column=1, padx=10, pady=5)currency_dropdown.current(0))
